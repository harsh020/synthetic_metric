...
class ModelMetric(BaseMetric):
    ...
    def _get_num_cat_columns(self, real_data):
        ...
        num_cols = list(real_data.select_dtypes(exclude=Dtypes.NUMERIC).columns)
    ...
    def _preprocess_data(self, real_data, synthetic_data):
        ...
        num_cols, cat_cols = self._get_num_cat_columns(real_data)

        real_cat, real_num = real_data[cat_cols], real[num_cols]
        synthetic_cat, synthetic_num = synthetic_data[cat_cols], real[num_cols]
